...
# ! Validation Process
def validation(epoch, model, data_loader, criterion, classes, _wandb, thr=0.7):
    print()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default="DeepLabV3_resnet50_custom", help='model type (default: BaseModel)')
